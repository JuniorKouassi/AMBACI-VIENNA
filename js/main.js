...
const translations = {
  ...
  fr: {
    ...
    'pays.subtitle': "L'Ambassade de Côte d'Ivoire à Vienne exerce sa circonscription diplomatique sur 8 pays d'Europe centrale et des Balkans.",
    ...
    'footer.desc':   "Ambassade de la République de Côte d'Ivoire en Autriche, desservant 8 pays d'Europe centrale. Service consulaire officiel sous l'autorité du Ministère des Affaires Étrangères.",
    ...
    'pays.hr':'Croatie','pays.rs':'Serbie','pays.ro':'Roumanie','pays.ba':'Bosnie-Herzégovine',
    ...
    'pcon.h.badge':  'Horaires',    'pcon.h.title':"Heures d'ouverture",
    ...
    'pamb.desc':     "Représentation officielle de la République de Côte d'Ivoire en Autriche depuis Vienne, assurant les relations diplomatiques et les services consulaires pour 8 pays d'Europe centrale.",
    ...
    'pamb.pays.sub': "L'Ambassade de Côte d'Ivoire à Vienne couvre la circonscription diplomatique des 8 pays suivants.",
    ...
    'pamb.mis.p3':   "Au titre de sa compétence territoriale, l'Ambassade couvre 8 pays : l'Autriche, la Hongrie, la Slovénie, la Slovaquie, la Croatie, la Serbie, la Roumanie et la Bosnie-Herzégovine.",
  ...
  de: {
    ...
    'pays.subtitle': 'Die Botschaft der Elfenbeinküste in Wien ist für Staatsangehörige zuständig, die in den folgenden 8 Ländern leben.',
    ...
    'footer.desc':   "Botschaft der Republik Côte d'Ivoire in Österreich, zuständig für 8 mitteleuropäische Länder. Konsulardienst.",
    ...
    'pays.hr':'Kroatien','pays.rs':'Serbien','pays.ro':'Rumänien','pays.ba':'Bosnien und Herzegowina',
    ...
    'pcon.h.badge':  'Öffnungszeiten', 'pcon.h.title':'Öffnungszeiten',
    ...
    'pamb.desc':     "Offizielle Vertretung der Republik Côte d'Ivoire in Österreich, zuständig für 8 mitteleuropäische Länder.",
    ...
    'pamb.pays.sub': 'Die Botschaft ist für Staatsangehörige in den folgenden 8 Ländern zuständig.',
    ...
    'pamb.mis.p3':   'Im Rahmen ihrer territorialen Zuständigkeit deckt die Botschaft 8 Länder ab: Österreich, Ungarn, Slowenien, Slowakei, Kroatien, Serbien, Rumänien und Bosnien-Herzegowina.',
  ...
  en: {
    ...
    'pays.subtitle': "The Embassy of Côte d'Ivoire in Vienna has consular jurisdiction over 8 Central European and Balkan countries.",
    'actu.badge':    'News',
    ...
    'footer.desc':   "Embassy of the Republic of Côte d'Ivoire in Austria, serving 8 Central European countries. Official consular service.",
    ...
    'pays.hr':'Croatia','pays.rs':'Serbia','pays.ro':'Romania','pays.ba':'Bosnia-Herzegovina',
    ...
    'pcon.h.badge':  'Hours',     'pcon.h.title':'Opening Hours',
    ...
    'pamb.desc':     "Official representation of the Republic of Côte d'Ivoire in Austria, serving 8 Central European countries.",
    ...
    'pamb.pays.sub': 'The Embassy of Côte d\'Ivoire in Vienna is competent for nationals in the following 8 countries.',
    ...
    'pamb.mis.p3':   "Within its territorial jurisdiction, the Embassy covers 8 countries: Austria, Hungary, Slovenia, Slovakia, Croatia, Serbia, Romania and Bosnia-Herzegovina.",
